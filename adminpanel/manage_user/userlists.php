            ...
            <div class="sidebar d-flex flex-column gap-1">
                ...
                <div class="sidebar-activities">
                    ...
                    <ul style=" padding-left:30px" id="user-lists">
                        <li class="admin-sidebar-content-list"><a href="#" class="active-sidebar sidebar-content-lists">User Lists</a></li>
                    </ul>
                    ...
                    <ul style="padding-left:30px; display:none" id="message-lists">
                        <li class="admin-sidebar-content-list"><a href="../messages/message_list.php">Messages List</a></li>
                    ...
                    <div class="card-body">
                        <div class="">
                            <form class="row gap-2">
                                <div class="col-12">
                                    <h2 class="page-title">User Lists</h2>
                                </div>
